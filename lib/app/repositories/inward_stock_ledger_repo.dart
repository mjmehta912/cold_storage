...
class InwardStockLedgerRepo {
  Future<InwardStockLedgerDetailResModel?> getInwardStockLedgerDetailFromServer(
    ...
    try {
      ...
      var res = await ApiService().postRequest(
        endPoint: ApiConstants.getInwardStockLedgerDetails,
      ...
      if (res != null) {
        if (res.statusCode == subscriptionOverStatusCode ||
          ...
          var decodedRes = inwardStockLedgerDetailResModelFromJson(res.body);
      ...
      LoggerUtils.logException('getInwardStockLedgerDetailFromServer', e);
    }
    return null;
  }
}
