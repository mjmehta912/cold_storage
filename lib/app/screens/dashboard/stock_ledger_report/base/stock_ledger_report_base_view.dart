...
import 'stock_ledger_report_base_controller.dart';

class StockLedgerReportBaseView
    extends GetView<StockLedgerReportBaseController> {
  final bool? isComingFromHome;

  StockLedgerReportBaseView({super.key, this.isComingFromHome}) {
  ...
  Widget _searchByInwardNo(BuildContext context) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Padding(
