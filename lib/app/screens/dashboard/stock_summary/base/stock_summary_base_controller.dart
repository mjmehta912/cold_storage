...
import 'package:cold_storage/app/general_model/res/closing_bal_model.dart';
...
class StockSummaryBaseController extends GetxController {
  ...
  void onInit() {
    ...
    closingBalList.addAll(ClosingBalModel.closingBalList);
    selectedClosingBal = closingBalList[0];
